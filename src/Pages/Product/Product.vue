                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox14">
                                    <input type="checkbox" class="toggle-switch-input" id="stocksCheckbox14" >
                                    <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox16">
                                    <input type="checkbox" class="toggle-switch-input" id="stocksCheckbox16" >
                                    <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox17">
                                    <input type="checkbox" class="toggle-switch-input" id="stocksCheckbox17" >
                                    <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox18">
                                    <input type="checkbox" class="toggle-switch-input" id="stocksCheckbox18" >
                                    <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                                </label>
