                            ...
                            <ul class="nav nav-tabs nav-justified" id="notificationTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="notificationNavTwo-tab" data-toggle="tab"
                                        href="#notificationNavTwo" role="tab" aria-controls="notificationNavTwo"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col ml-n3">
                                                        ...
                                                        <p class="card-text font-size-sm">changed an issue from "In
                                                            Progress" to <span class="badge badge-success">Review</span>
                                                        </p>
                                                    </div>
                                            ...
                                            <li class="list-group-item custom-checkbox-list-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col ml-n3">
                                                        ...
                                                        <p class="card-text font-size-sm">joined the Slack group HS Team
                                                        </p>
                                                    </div>
                                            ...
                                            <li class="list-group-item custom-checkbox-list-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col ml-n3">
                                                        ...
                                                        <p class="card-text font-size-sm">Start using forms to capture
                                                            the information of prospects visiting your Google website
                                                        </p>
                                                    </div>
                                            ...
                                            <li class="list-group-item custom-checkbox-list-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col ml-n3">
                                                        ...
                                                        <p class="card-text font-size-sm">accepted your invitation to
                                                            join Notion</p>
                                                    </div>
                                            ...
                                            <li class="list-group-item custom-checkbox-list-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col ml-n3">
                                                        ...
                                                        <p class="card-text font-size-sm">left Slack group HS projects
                                                        </p>
                                                    </div>
                                                    <small class="col-auto text-muted text-cap">3dy</small>
                                                </div>
                                            ...
                                            <li class="list-group-item custom-checkbox-list-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col ml-n3">
                                                        ...
                                                        <p class="card-text font-size-sm">completed <i
                                                                class="tio-folder-bookmarked text-primary"></i> FD-134
                                                            task</p>
                                                    </div>
                                                    <small class="col-auto text-muted text-cap">2mn</small>
                                                </div>
                                    ...
                                    <a class="nav-link" href="#">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body text-truncate">
                                                ...
                                                <span class="d-block font-size-sm text-body">Security and control across
                                                    Cloud</span>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a class="nav-link" href="#">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body text-truncate">
                                                ...
                                                <span class="d-block font-size-sm text-body">Work involved in developing
                                                    a website</span>
                                            </div>
                                        </div>
                                    </a>
